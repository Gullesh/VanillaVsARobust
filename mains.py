...
torch.save(lslb, '/home/mallet/Desktop/VanillaVsARobust/salmaps/'+args.method +args.model+'sal.pt')
l = np.asarray(l)     
savetxt('/home/mallet/Desktop/VanillaVsARobust/Runtimes/time'+args.method+args.model+'.csv', l, delimiter=',')
print('Pointing game accuracy: ',pgtot)
